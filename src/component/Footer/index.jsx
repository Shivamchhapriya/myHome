                        ...
                        <div class="row ms-5">
                            ...
                            <div class="col-xl-4 col-sm-12 mt-3">
                                <div class="single-cta">
                                    ...
                                    <div class="cta-text">
                                        <h4>Mail us</h4>
                                        <span>royalhousemakers@gmail.com</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="footer-content pt-5 pb-3">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-30">
                                <div class="footer-widget">
                                    <div class="footer-widget-heading ms-3 mt-4">
                                        <h3>Useful Links</h3>
                                    </div>
                        ...
                        <div class="row" style={{padding:"10px 0px"}}>
                            <div class="col-xl-12 col-lg-12 text-center text-lg-left">
                                <div class="copyright-text">
                                    <p>Copyright &copy; 2023, All Right Reserved <a href="#">Anup</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
