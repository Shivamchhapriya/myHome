...
function Service() {
  ...
  const videos = ['https://youtu.be/l4L4qBYrpyY'];
          ...
          <div className='col-lg-6'>
            <div className='p_1 img_set mt-2'>
              <div className='full-width-paragraph'>
                <div className='text-start'>
                  <p className='text-black' >
                    <h5 className='react'>3D ELEVATION DESIGN</h5><br />
                  ...
                  <strong className='react'>Here's are detailed of 3D elevation:</strong><br />
                  <p className='text-black' style={{ margin: "2px" }}>
          ...
          <div className='col-lg-6'>
            <div className='p_1 img_set mt-2'>
              <div className='full-width-paragraph'>
                <div className='text-start'>
                  <p className='text-black' >
                    <h5 className='react' style={{ margin: "0px" }}>2D Elevation</h5><br />
                  ...
                  <strong className='react'>Here's comprehensive guide to Understanding and explaining 20 Elevation Design:</strong><br />
                  <p className='text-black' style={{ margin: "2px" }}>
              ...
              <div className='full-width-paragraph'>
                <div className='text-start'>
                  <p className='text-black' style={{ margin: "0px" }}>
                    <h5 className='react' >STRUCTURE DRAWING</h5><br />
                  </p>
                  <p className='text-black'>
                  ...
                  <strong className='react'>Purpose and Significance :</strong><br />
                  <strong className='react'>Representation</strong>: Structure drawings visually communicate how a building's structural components come together, they details the arrangements, sizes and connection of critical elements.<br></br>
                  <strong className='react'>Technical documentation</strong>: These drawings provide essential information for construction ensuring the buildings stability, safety and assurance to engineering principles<br></br>
                  <strong className='react'>Here's are detailed of Structure Drawing:</strong><br />
                  <div className='row'>
            ...
            <div className='p_1 img_set mt-2'>
              <div className='full-width-paragraph'>
                <div className='text-start'>
                  ...
                  <p className='text-black text-start' style={{ margin: "2px" }}>
          ...
          <div className='col-lg-6'>
            <div className='p_1 img_set mt-2'>
              <div className='full-width-paragraph'>
                <div className='text-start'>
                  <p className='text-black' >
                    <h5 className='react'>LANDSCAPE</h5><br />
                  ...
                  <strong className='react'>Here's are detailed of Lnadscape:</strong><br />
