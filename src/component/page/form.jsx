...
<div class="form-group col-sm-2 pe-0 mb-0 ps-1 has-error has-feedback input-Width">
<input type="number" name="width" class="form-control" id="width" aria-describedby="width" placeholder="Width"/>
</div>
<div class="form-group col-sm-2 pe-0 mb-0 ps-1 has-success input-Width">
...
<div class="form-group col-sm-2 ps-1 mb-0 input-Width" >
...
<button type="submit" id="btn_submit" value="Next" style={{background:'#3bad4b',border:'#3bad4b',color:'white'}} class="btn  w-100 mb-0">Calculate
Price</button>
</div>
     </form>
            </div>
